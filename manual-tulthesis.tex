...
% \documentclass[numbering,twoside,margins]{./tulpackage/tulthesis}
...
% Doplňující balíčky pro tabulky a obrázky (PŘIDÁNO)
\usepackage{float}    % Umožňuje použití [H]
\usepackage{booktabs} % Umožňuje \midrule, \bottomrule

% Nastavení písma (náhrada noto sans mono kvůli nedostupnosti kurzivy)
\setmonofont{RobotoMono}[
    Path = ./tulpackage/fonts/, % chktex 26
...
% Změňte nebo zakomentujte vspace podle toho, kolik položek bude v seznamech
\listoffigures%
