...
\definecolor{tullightgray}{gray}{0.95}%
...
\newboolean{TUL@srccapsleft}%
\setboolean{TUL@figcapsleft}{false}%
\setboolean{TUL@tabcapsleft}{false}%
\setboolean{TUL@lstcapsleft}{false}%
\setboolean{TUL@srccapsleft}{false}%

% Přepnutí popisků pro obrázky, tabulky a bloky kódu do kurzivy
\newboolean{TUL@italiccaps}%
\setboolean{TUL@italiccaps}{false}%
