...
% Obsahuje: Nastavení geometrie stránky a odsazení nadpisů

% ==========================================================================
% Styl stránky a globální nastavení
% ==========================================================================
...
% Brání roztažení stránek, ze kterých odskočila ilustrace na následující
...
\ifthenelse{\lengthtest{\paperwidth=210mm}\AND\lengthtest{\paperheight=297mm}}{%
    ...
    \ifTUL@margins
        ...
        \setlength{\textwidth}{\dimexpr\paperwidth-55mm\relax}%
    \else
...
% Široký režim (přenastavení okrajů)
\newcommand{\TULwide}{%
    \setlength{\oddsidemargin}{0mm}%
    \setlength{\evensidemargin}{0mm}%
    \setlength{\textwidth}{\dimexpr\paperwidth-50mm\relax}%
