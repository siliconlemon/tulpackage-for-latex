...
% * Boolean definice booleans jsou v basics.tex kvůli správnému načítání
...
% Možnost "margins" pro zapnutí odsazení zleva a zprava v dokumentu
...
% Možnost "captionsleft" zarovnává všechny popisky obrázků apod. do leva
...
% Možnosti pro zarovnání jednotlivých popisků doleva (použíbat BEZ cationsleft)
\DeclareOption{figcapsleft}{%
  \setboolean{TUL@figcapsleft}{true}%
}
\DeclareOption{tabcapsleft}{%
  \setboolean{TUL@tabcapsleft}{true}%
}
\DeclareOption{lstcapsleft}{%
  \setboolean{TUL@lstcapsleft}{true}%
}

% Možnost "singlecapnumbers" pro čísla popisků bez předčstlí kapitol
...
% Možnost "nocapnumbers" pro vypnutí číslování popisků
\DeclareOption{nocapnumbers}{%
  \setboolean{TUL@nocapnumbers}{true}%
}
